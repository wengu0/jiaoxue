        ...
        <form action="classes_update_handler.php" method="post">
            <table width="500" border="1" height="400" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" readonly name="cls_id" value='<?php echo $cls_id; ?>'></td>
                </tr>
                <tr>
                    <td align="center">名称：</td>
                    <td><input type="text" name="cls_name" value='<?php echo $row["cls_name"]; ?>'></td>
                </tr>
                <tr>
                    <td align="center">入学时间：</td>
                    <td><input type="text" name="cls_count" value='<?php echo $row["cls_count"]; ?>'></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="specialty_name" value='<?php echo $row["specialty_name"]; ?>'></td>
                </tr>
                <tr>
